                    ...
                    {[1, 2, 3, 4, 5, 6].map(i => (
                      <div key={i} className="group relative aspect-square overflow-hidden border border-zinc-100 dark:border-zinc-900 bg-zinc-50 dark:bg-zinc-900/40">
                          ...
                          <img 
                            ...
                            onError={(e) => {
                              e.currentTarget.src = "https://images.unsplash.com/photo-1552664199-fd31f7431a55?auto=format&fit=crop&q=80&w=800";
                            }}
                          />
                          
                          {/* Overlay Label */}
                          <div className="absolute bottom-4 left-4 text-left">
                            <span className="block text-[7px] font-black uppercase tracking-[0.3em] text-red-600 mb-1">Out of Stock</span>
                            <span className="block text-[9px] font-black uppercase tracking-widest text-foreground bg-background/80 backdrop-blur-sm px-2 py-1">
                              Drop 00{i} / Archive
                            </span>
                          </div>
                      </div>
                ...
                <div className="grid md:grid-cols-2 gap-20 items-center">
                  <div className="space-y-8">
                    ...
                    <div className="space-y-6 text-[11px] font-bold uppercase tracking-widest leading-loose text-zinc-500">
                      <p>
                        ARC is an experimental project focused on high-quality silhouettes and brutalist aesthetics. 
                        Based in the Philippines, we aim to redefine local streetwear through premium materials and architectural design.
                      </p>
                      <p>
                        Every piece is constructed with 240GSM to 450GSM fabrics, ensuring longevity and a distinct weight 
                  ...
                  <div className="relative aspect-[4/5] overflow-hidden border border-zinc-100 dark:border-zinc-900 bg-zinc-50 dark:bg-zinc-900/40">
                    <img 
                      ...
                      alt="ARC Design Studio" 
                      className="h-full w-full object-cover grayscale transition-all duration-1000 hover:grayscale-0 hover:scale-105"
                      onError={(e) => {
                        e.currentTarget.src = "/archives5.jpg";
                      }}
                    />

                    <div className="absolute top-0 right-0 p-4">
                      <span className="text-[8px] font-black uppercase tracking-[0.5em] text-zinc-400 [writing-mode:vertical-lr]">
                        EST_2024
                      </span>
                    </div>
                  </div>
